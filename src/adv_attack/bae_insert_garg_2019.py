"""
This file is a modified version of the original file from the TextCRS codebase.
...
class BAEInsertGarg2019(AttackRecipe):
    ...
    def build(model_wrapper):
        ...
        return BAEInsertGarg2019(goal_function, constraints, transformation, search_method)
